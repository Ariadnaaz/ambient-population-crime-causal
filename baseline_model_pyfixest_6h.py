...
def generate_regression_results_model1(lags, cities, crime_types, footfall_factor, model_type):
    ...
    for city in cities:
        ...
        for crime in crime_types:
            ...
            if model_type == 'NB':
                ...
                print(model.summary()) #.as_text(float_format="%.8f")
            ...
            city_results_df.to_csv(f"results/Baseline_model/sample_correction_city_1SD/{city}_{model_type}_results_6H.csv",index=False)
            print(f"Saved {city} + {crime_str} results!")

generate_regression_results_model1(lags=[0],
