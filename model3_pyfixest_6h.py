...
def generate_regression_results_model3(lags, cities, model_name, crime_types, covariates, footfall_factor):
    ...
    for city in cities:
        ...
        for crime in crime_types:
            ...
            # repeat daily values for each hour of the day
            ...
            # merge them into df
            df = (
                df.merge(df_sports_hr, on="datetime", how="left")
            ...
            # create time fixed effects: hour of day, day of week, month
            ...
            city_results_df.to_csv(f"results/Model_with_DL&FE/sample_correction_city_1SD/{city}_Pfixest_results_{model_name}_6H.csv",index=False)
            print(f"Saved {city} results!")

generate_regression_results_model3(lags=[0,1,2],
